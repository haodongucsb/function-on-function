source("subfun.R")
sourceCpp("Funanovahighorder.cpp")
library(fda)
library(assist)
library(Rcpp)
library(Matrix)
...
# ds: a vector of length 11 with component value 0 or 1, where 1 means the corresponding parametric component used in model fit. If ignoring high order interaction, set the 9th, 10th, and 11th components to be 0.
# thetas: a vector of length 10 with component value 0 or 1, where 1 means the corresponding nonparametric component used in model fit. If ignoring high order interaction, set the 8th, 9th, and 10th components to be 0.

funanova.general.parallel.ho.l2<-function(x,datax,datay,ny=10,nbasis=10,norder=4,lamb=0.0001,bf.lamb=0.001,maxit=100,xmin=0,xmax=1,limnla=c(-0.1,0.1),ds=NULL,thetas=NULL)
{
  n=dim(datay)[2]
  m=dim(datay)[1]
...
######### create RK matrices ################
  ...
  Q1tmp=list(Sigma1s,Sigma3s,Sigma4s,Sigma13,Sigma14,Sigma24,Sigma34,Sigma124,Sigma234,Sigma1234)
  qlen=length(Q1tmp)
  ...
  rm(Sigma1s,Sigma3s,Sigma4s,Sigma13ls,Sigma13sl,Sigma13ss,Sigma14ls,Sigma14sl,Sigma14ss,
     Sigma24ls,Sigma24sl,Sigma24ss,Sigma34ls,Sigma34sl,Sigma34ss,Sigma13,Sigma14,Sigma24,Sigma34,Sigma124,Sigma234,Sigma1234)
...
# ds: a vector of length 6 with component value 0 or 1, where 1 means the corresponding parametric component used in model fit. If ignoring high order interaction, set the 6th component to be 0.
# thetas: a vector of length 5 with component value 0 or 1, where 1 means the corresponding nonparametric component used in model fit. If ignoring high order interaction, set the 5th component to be 0.

funanova.EFLM.parallel.ho.l2<-function(x,datax,datay,ny=10,nbasis=10,norder=4,lamb=0.0001,bf.lamb=0.001,maxit=100,xmin=0,xmax=1,limnla=c(-0.1,0.1),ds=NULL,thetas=NULL)
{
  n=dim(datay)[2]
  m=dim(datay)[1]
 ...
 {  xi=datax[,i]
  ...
  for(ij in 1:dim(parind)[1])
  {
    ...
    Sigma124[(i-1)*ny+j,] = tempres[[ij]][9,]
  ...
  Sigma14=Sigma14ls+Sigma14sl+Sigma14ss
  Sigma24=Sigma24ls+Sigma24sl+Sigma24ss
  Q1tmp=list(Sigma1s,Sigma4s,Sigma14,Sigma24,Sigma124)
  ...
  rm(Sigma1s,Sigma4s,Sigma14ls,Sigma14sl,Sigma14ss,Sigma24ls,Sigma24sl,Sigma24ss,Sigma124)
  rm(Rmat.xxt21,Rmat.xxt12,Rmat.xxt22)
